        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control mb-1" value="<?php echo $user['phoneNumber']; ?>" type="tel" maxlength="11" pattern="^\d{11}$" title="Phone number must be exactly 11 digits" name="phoneNumber" id="phoneNumber" required>
                </div>
            </div>
